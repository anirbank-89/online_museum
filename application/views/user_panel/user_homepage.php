  ...
  <div id="topnav_container" style="background-color:green;height:53px;position:sticky;top:0%;z-index:100">
    <div id="topnav">
      ...
      <li id="about_list">
        ...
        <div id="about_div">
          <a href="<?php echo base_url().'index.php/MuseumController/user_about_us_data'?>">About us</a>
          <a href="<?php echo base_url().'index.php/MuseumController/user_privacy_policy_data'?>">Privacy Policy</a>
        </div>
      </li>
      <li id="view_list">
        <a id="view_link">VIEW</a>
        <div id="view_div">
          <a href="<?php echo base_url().'index.php/MuseumController/display_arts_data'?>">Arts Gallery</a>
          <a href="<?php echo base_url().'index.php/MuseumController/display_birds_data'?>">Birds Gallery</a>
          <a href="<?php echo base_url().'index.php/MuseumController/display_animals_data'?>">Animals Gallery</a>
          <a href="<?php echo base_url().'index.php/MuseumController/display_painting_data'?>">Painting Gallery</a>
          <a href="<?php echo base_url().'index.php/MuseumController/display_egypt_data'?>">Egypt Gallery</a>
          <a href="<?php echo base_url().'index.php/MuseumController/display_fossil_data'?>">Ancient Fossil Gallery</a>
        </div>
      </li>
      <li><a href="<?php echo base_url().'index.php/MuseumController/display_notice_data2'?>">NOTICE</a></li>
      <!-- <li><a href="#">LINK</a></li> -->
      <li id="contact_list">
        <a id="contact_link">CONTACT  US</a>
        <div id="contact_div">
          <?php
          foreach ($data as $row) { 
          ?>
          <a href="feedback_data2?name=<?php echo $row->name?>&email=<?php echo $row->email?>&img=<?php echo $row->picsource?>&">Leave a feedback</a>
          <?php
          }
          ?>
          <a href="<?php echo base_url().'index.php/MuseumController/user_contact_data'?>">Contact</a>
        </div>
      </li>
      <li id="active"><a id="log_in" href="<?php echo base_url().'index.php/MuseumController/user_logout_data'?>">LOG OUT</a></li>
      </ul>
    </div>
  </div>
...
<!-- ----------------------------------------------------------------- --> 
    ...
    <div id="f_notice_container" style="box-shadow: 0 5px 5px 0 rgba(0,0,0,0.5)">
      <h3>The largest museum across India and boasts exquisite collections of armor, antiques, ornaments, skeleton, fossils, mummies, beautiful Mughal paintings..</h3>
    </div> 
    ...
    <div id="what_we_have_container">
      <div id="content">
        ...
        <div id="gallery">
          <ul>
            <h2><li>Gallery</h2>
              <h4><ul>
                <li><a href="<?php echo base_url().'index.php/MuseumController/display_arts_data'?>">Art Gallery</a></li>
                <li><a href="<?php echo base_url().'index.php/MuseumController/display_birds_data'?>">Bird Gallery</a></li>
                <li><a href="<?php echo base_url().'index.php/MuseumController/display_animals_data'?>">Animals Gallery</a></li>
                <li><a href="<?php echo base_url().'index.php/MuseumController/display_painting_data'?>">Painting Gallery</a></li>
                <li><a href="<?php echo base_url().'index.php/MuseumController/display_egypt_data'?>">Egypt Gallery</a></li>
                <li><a href="<?php echo base_url().'index.php/MuseumController/display_fossil_data'?>">Ancient Fossil Gallery</a></li>
              </ul></h4>
            </li>
          </ul>  
        </div>
      ...
      <div id="video">
        ...
        <div id="video_museum365">
          ...
          <source src="video/museum365.mp4" type="video/mp4">
...
<!-- ----------------------------------------------------------------- -->
    ...
    <div id="footer_container">
      ...
      <div id="footer_link">
        ...
        <div> 
          <label><a href="<?php echo base_url().'index.php/MuseumController/user_privacy_policy_data'?>">Privacy Policy</a></label>
          <br><br>
          <label><a href="<?php echo base_url().'index.php/MuseumController/display_notice_data2'?>">Notice</a></label>
          <br><br>
          <label><a href="<?php echo base_url().'index.php/MuseumController/user_contact_data'?>">contact</a></label>
          <br><br>
          <label><a href="<?php echo base_url().'index.php/MuseumController/user_about_us_data'?>">About Us</a></label>
          <br><br>
        </div> 
      </div>
